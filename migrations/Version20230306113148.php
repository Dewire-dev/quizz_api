...
final class Version20230306113148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, quiz_id INT NOT NULL, label VARCHAR(255) NOT NULL, position SMALLINT NOT NULL, INDEX IDX_B6F7494EBA934BCD (quiz_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quiz (id INT AUTO_INCREMENT NOT NULL, creator_id INT DEFAULT NULL, category VARCHAR(50) NOT NULL, subject VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_7C77973D61220EA6 (creator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quiz_launch (id INT AUTO_INCREMENT NOT NULL, launcher_id INT NOT NULL, quiz_id INT NOT NULL, current_question_id INT DEFAULT NULL, ulid VARCHAR(26) NOT NULL, status VARCHAR(255) NOT NULL, start_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', end_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_234871E42724B909 (launcher_id), INDEX IDX_234871E4BA934BCD (quiz_id), INDEX IDX_234871E4A0F35D66 (current_question_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quiz_launch_participant (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, quiz_launch_id INT NOT NULL, participant_status VARCHAR(255) NOT NULL, current_score INT NOT NULL, INDEX IDX_CB0C9579A76ED395 (user_id), INDEX IDX_CB0C957986893C7A (quiz_launch_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
